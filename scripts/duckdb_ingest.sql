...
CREATE OR REPLACE TABLE raw.novelan_heatpump_compressor_starts_v1 AS SELECT DISTINCT ON (created_date) * FROM read_csv('data/novelan/heatpump/v2/novelan_heatpump_compressor_starts.csv');
