...
CREATE OR REPLACE TABLE raw.novelan_heatpump_v2 AS SELECT * FROM read_csv('ingest/novelan/heatpump/v2/*.csv', decimal_separator = ',', types={'AnalogOut_2': 'VARCHAR', 'TBW_Soll': 'DOUBLE'});