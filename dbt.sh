...
dbt --quiet run-operation generate_source --args '{"schema_name": "raw", "database_name": "smarthome_dwh", "table_names":["heatpump"], "generate_columns": true}' > models/sources/sources.yml
